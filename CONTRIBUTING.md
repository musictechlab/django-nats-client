# Contributing to django-nats-client
...
1. Check existing [issues](https://github.com/musictechlab/django-nats-client/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/django-nats-client/discussions)
